...
```{r}
countdown::countdown(minutes = 0, seconds = 55, left = 0, id = "air_timer", font_size = "1.5em")
```
...
```{r}
countdown::countdown(minutes = 2, seconds = 55, left = 0, id = "air_timer", font_size = "1.5em")
```
...
```{r}
countdown::countdown(minutes = 1, seconds = 55, left = 0, id = "air_timer", font_size = "1.5em")
```
